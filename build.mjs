...
const baseUrl = "https://perfectbest-massage.pages.dev";
const brand = "간다GO";
...
const nav = [
  ["홈", "/", []],
  ["수도권 안내", "/", [["서울", "/seoul/"], ["경기", "/gyeonggi/"], ["인천", "/incheon/"]]],
...
const pages = [
  ...
  makePage("seoul/", "서울 출장마사지｜강남·잠실·홍대·여의도 홈타이 예약 안내", "서울 출장마사지 예약 전 강남·잠실·홍대·여의도 방문 기준을 확인하세요.", "서울 출장마사지 방문 가능 지역 안내", richBody("서울", "서울은 강남, 잠실, 홍대, 여의도처럼 상권과 업무지구가 촘촘하게 이어지는 지역입니다. 서울 출장마사지 예약 전에는 건물 출입 방식, 주차 또는 도보 이동, 심야 시간대 상담 가능 여부를 함께 확인하는 것이 좋습니다.", '<div class="card-grid"><a class="card" href="/seoul/gangnam-gu/"><h3>강남구</h3><p>강남역, 역삼, 삼성, 논현 생활권.</p></a><a class="card" href="/seoul/life/gangnam-yeoksam/"><h3>강남·역삼</h3><p>업무지구와 오피스텔 방문 기준.</p></a></div>'), [["서울", null]]),
...
for (const page of pages) console.log(`${page.path || "/"} ${page.desc.length} chars`);
